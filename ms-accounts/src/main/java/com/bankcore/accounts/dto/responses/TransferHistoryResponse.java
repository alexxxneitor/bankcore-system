...
/**
 * {@code TransferHistoryResponse} is an immutable Data Transfer Object (DTO)
 * that represents the details of a single transfer transaction in a user's
 * transaction history.
 *
 * <p>This class is typically used as an API response model to provide
 * clients with structured information about transfers, including
 * transaction type, amount, balance, and counterparty details.</p>
 *
