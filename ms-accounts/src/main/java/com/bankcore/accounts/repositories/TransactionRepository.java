...
public interface TransactionRepository extends
         ...
         * </p>
         *
         * @param accountId the UUID of the account whose latest transaction is
         *                  requested
        ...
        /**
         * Calculates the total amount of completed withdrawals for a specific account
         * since a given time.
         * <p>
         ...
         * {@code COALESCE} is used to return a default value of {@code 0.0} if no
         ...
         * @param startOfDay the inclusive start time for the calculation (typically the
